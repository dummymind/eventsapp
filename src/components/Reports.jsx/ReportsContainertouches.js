...
import './ReportsContainertouches.css'
...
const ReportsContainer = () => {
  ...
  return (
    <div>
<nav className="navbar navbar-expand-lg mb-2 mt-2">
...
<nav className="second-navbar navbar navbar-expand-lg mt-4 mb-4 rounded">
  <div className="container-fluid">
  {/* <a className="navbar-custom-home navbar-brand rounded p-2" href="#">
    <img
      src={HomeIcon}
  ...
  <h5 className='report-heading m-2'><b>Reports</b></h5>
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="card-container">
        <div className="cards"><div className="card-header">Total Events in Touches  <br/> {eventCount}</div></div> 
      ...
      <div className="card-container">'
        <div className="cards p-0">
          <div className="card-header card-header-custom">COMPLETED TOUCHES</div>
          <div className="grid-container-custom mb-4">

<div className="row custom-row-touches m-1">
<div className="col second-navbar rounded m-2 p-3">2023</div>
<div className="col second-navbar rounded m-2 p-3">2023</div>
<div className="col second-navbar yellow rounded m-2 p-3">2024</div>
</div>

<div className="row custom-row-touches m-2">
<div className="col second-navbar rounded p-3">345</div>
<div className="col second-navbar rounded p-3">561</div>
<div className="col second-navbar rounded p-3">1340</div>
</div>
      ...
      <div className="card-container">'
        <div className="cards p-0">
          <div className="card-header card-header-custom">FUTURE TOUCHES</div>
          <div className="grid-container-custom mb-4">

<div className="row custom-row-touches m-1">
<div className="col second-navbar rounded m-2 p-3">2025</div>
<div className="col second-navbar rounded m-2 p-3">2026</div>
<div className="col second-navbar rounded m-2 p-3">2027</div>
</div>

<div className="row custom-row-touches m-2">
<div className="col second-navbar rounded p-3">120</div>
<div className="col second-navbar rounded p-3">70</div>
<div className="col second-navbar rounded p-3">0</div>
</div>

...
const FamilyMembers = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://touchmarsapi2024.azurewebsites.net/api/SiteVisitdetails/Visitcompletedfamilymemdetails'); // Replace with your actual API endpoint
